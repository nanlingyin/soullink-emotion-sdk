...
export default defineConfig(({ command, mode }) => {
  ...
  const localPublicDir = resolve(rootDir, env.SOULLINK_DEMO_PUBLIC_DIR || "apps/web/public");
  ...
  return {
    ...
    publicDir: includeLocalAssets && existsSync(localPublicDir) ? localPublicDir : false,
